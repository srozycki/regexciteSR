...
The goal of regexciteSR is to make regular expressions more exciting!
...
You can install the development version of regexciteSR from [GitHub](https://github.com/) with:
